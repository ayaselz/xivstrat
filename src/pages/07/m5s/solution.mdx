...
import FlipToXSideAbility from '@/pages/07/m5s/_components/FlipToXSideAbility.astro'
import XSnapTwistAndDropTheNeedleAbility from '@/pages/07/m5s/_components/XSnapTwistAndDropTheNeedleAbility.astro'

<MechanicSection time="00:09.173">
...
<SolutionSection time="00:09.173">
...
<MechanicSection time="00:38.937">
  <div class="flex flex-col gap-4">
    ...
    <div class="flex flex-col gap-4">
      <div class="gap-strat flex items-center">
        根据读条和特效不同，先攻击一侧半场
        <Span variant="yellow"><Span variant="violet">(</Span>2<Span variant="violet">|</Span>3<Span variant="violet">|</Span>4<Span
            variant="violet">)</Span></Span>
        次，再攻击另一侧半场
...
<SolutionSection time="00:38.937" id="flip-to-x-side-jp" title="解法：日野主流">
  <div class="flex flex-col gap-4">
    <div class="gap-strat flex items-center">
      先根据读条和特效躲避
      <XSnapTwistAndDropTheNeedleAbility />
...
<SolutionSection time="00:38.937" title="解法：三五分摊">
  <div class="flex flex-col gap-4">
    <div class="gap-strat flex items-center">
      先根据读条和特效躲避
      <XSnapTwistAndDropTheNeedleAbility />
...
<NoteSection time="00:41.873">
    <div class="flex items-center gap-strat">必定和前一次不同</div>
</NoteSection>
<NoteSection time="00:47.978">
    <div class="flex items-center gap-strat">必定和前一次不同</div>
</NoteSection>